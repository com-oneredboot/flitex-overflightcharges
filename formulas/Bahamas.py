"""
Bahamas Overflight Charges Formula

Currency: USD

Rates:
- En-route (origin or destination is Bahamas): $61.75 per 100 NM
...
def calculate(distance, weight, context):
    """
    Calculate Bahamas overflight charges.
    ...
    # Determine rate based on whether Bahamas is origin or destination
    if origin_country == "Bahamas" or destination_country == "Bahamas":
        rate = en_route_rate
    else:
        rate = oceanic_rate
